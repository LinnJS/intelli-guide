const perminant = {
 ...
 Figueres.The Pichots were an extended family whose many members included proficient musicians and artists.Dalí’s father believed an association with this artistic and musically talented family would be very beneficial to his son.In the Pichot dining room,
    the walls were lined with impressionist paintings,
    some by Ramon Pichot,
    an established Impressionist painter and a close friend of Pablo Picasso(1881 - 1976).One day while looking at Ramon’s works Dalí decided to become a painter.Dalí later said,
    “Impressionist painting attracted me at the time because it was considered anti - establishment and a revolutionary aesthetic theory.” ',
 'ExhibitionHistory' : [
 ...
 The young artist has represented himself as a young dandy,
    wearing a large floppy black hat,
    a black cape,
    a bold red scarf,
    and sporting a pipe,
    creating an unusual appearance that gained him some notoriety among the other students at the Residencia de Estudiantes in Madrid.That Dalí chose to use these props for this early self - portrait indicates that at the age of seventeen,
    he was already consciously building an eccentric public personality.Dalí’s eccentricity developed even earlier in an attempt to establish his own distinct identity.Dalí’s identity crisis was the result of having a brother who died nine months before his own birth and who was also named Salvador Dalí.The artist felt that his parents wanted him to be the replacement for the dead brother.Yet Dalí’s eccentricities helped him achieve a separate unique identity.Notable is the artist’s use of chiaroscuro,
    a technique where strong dark and light areas are contrasted to produce form.',
 'ExhibitionHistory': [
      '1965, New York, Gallery of Modern Art, “Salvador Dalí, 1910-1965”',
 ...
 Approximately four years later,
    Dalí returned to this celebrated canvas and transformed it by adding the second upside - down figure,
    which radically contrasts with the first and makes the finished painting a double portrait.While there is no documentation that details why Dalí transformed this work so thoroughly,
    it is believed to be either a reflection of Picasso’s profound influence after their first meeting in 1926,
    or as a symbol of developing tension between the artist and his sister.',
 'ExhibitionHistory': [
      '1965, New York, Gallery of Modern Art, “Salvador Dalí, 1910-1965”',
      '1995, St. Petersburg, Salvador Dali Museum, “The Young Dali: Works from 1914-1930”',
      '2006, Cleveland, Cleveland Museum of Art, “Barcelona & Modernity: Picasso, Gaudi, Miro, Dalí (1868-1939)”',
 ...
 The artist’s use of detailed illusionism and dramatic lighting against an almost black background alludes to the influence of the Spanish painter Francisco de Zurbarán(1598 - 1664),
    demonstrated in his work Still Life with Lemons,
    Oranges and a Rose,
    1633. A contemporary of Diego Velázquez(1599 - 1660),
    de Zurbarán was renowned for his works’ austere piety and quiet beauty.Dalí saw bread as the staple of life of the Catalan people.Bread was the most basic element that united Catalans in their daily lives,
    and like Vermeer and Zurbarán,
    he renders it as a sublime symbol.The painstaking realism of The Basket of Bread was a major achievement and marked a turning point in his career.It boosted Dalí’s ego and gave him a sense of mastery with traditional painting,
    freeing him to explore more difficult subject matter and imagery.This simple composition of bread in a straw basket on cloth is set dramatically against a dark background.Dalí followed in the Spanish still - life tradition,
    where a domestic scene represents spiritual reflection.By saturating the objects in such a mysterious light,
    he transforms the composition into an object of deep contemplation.',
 'ExhibitionHistory': [
 ...
 girl,
    she appears to be too large for the landscape in which she stands.Secondly,
    the girl’s face is hidden from view,
    creating a sense of mystery and not providing any psychological details that her features could provide.And lastly,
    while the landscape is painted in a fairly realistic manner,
    the curves of the girl’s body are highly exaggerated – looking like she stepped out of a dream.This girl originated in childhood fantasies about a fictional Russian girl whom he nicknamed “Galuchka.” He saw this girl in one of the images in an optical theater / stereoscopic box in the house of his childhood teacher,
    Señor Trayter.These images “were to stir[Dalí]for the rest of his life”.She became his dream girl onto whom he could project all of his desires.Dalí pays homage to neoclassicism and its Catalan variant Noucentisme proposed by the writer Eugenio \' Ors in this alluring painting.Here he represents the unusual the view of a young girl seen from behind and located in an Ampurdán landscape treated in an Italianate style.The representation of a figure viewed from behind is a pretext for painting the expansive landscape imbued with psychological tension,
    with its high sky and dramatic crescent moon,
    as we are invited to look over her shoulder and therefore identify with her point of view.Though her sculptural pose(or "contrapposto")and the treatment of the landscape point to classical motifs,
    the device of looking over her shoulder derives from Romantic painting,
    and her exaggeratedly curving hips introduce the erotic into what is otherwise a restrained subject.Dalí later explained how this figure was transformed from the adolescent girl Dullita into the literary figure of Gradiva and eventually reborn as his wife Gala.Gradiva was a mythic,
    literary phantasm,
    who was notable for how her foot was elegantly raised when walking,
    the subject of a popular novel analyzed by Freud at the beginning of the 1900 s,
    but only translated into French in 1931. At this time Dalí adopted this subject,
    making it part of his personal mythology and imbuing this figure with subjective symbolism.Indeed,
    Gradiva became one of the \' s central concerns during the 1930 s.',
 'ExhibitionHistory': [
      '1926, Barcelona, Galeries Dalmau, "Exposició S. Dalí"',
