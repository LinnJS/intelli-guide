...
},
{
  ...
  'Accession ID Number': '1983.1',
  'Credit Line': 'Gift of A. Reynolds & Eleanor Morse',
  'Location': 'ON VIEW',
  'Copyright': 'Worldwide rights ©Salvador Dalí. Fundació Gala-Salvador Dalí (Artists Rights Society), 2017 / In the USA ©Salvador Dalí Museum, Inc. St. Petersburg, FL 2017.',
  'Description': 'This self-portrait was painted during the most tumultuous time in Dalí’s life. Dalí’s mother, Felipa Doménech i Ferrés (1874-1921) died of cancer on February 8, 1921. Yet shortly after, Dalí was accepted to the San Fernando Royal Academy of Fine Arts in Madrid, which he began attending in the fall of 1922.
    The young artist has represented himself as a young dandy, wearing a large floppy black hat, a black cape, a bold red scarf, and sporting a pipe, creating an unusual  appearance that gained him some notoriety among the other students at the Residencia de Estudiantes in Madrid. That Dalí chose to use these props for this early self-portrait indicates that at the age of seventeen, he was already consciously building an eccentric public personality.
...
{
  'url': 'http://archive.thedali.org/MWEBimages/Collection Images/OILS_images saved for Web/1983.3_Portrait of My Sister_after conservation_web.jpg',
...
},
{
  ...
  'Accession ID Number': '1981.1',
  'Credit Line': 'Gift of A. Reynolds & Eleanor Morse',
  'Location': 'ON VIEW',
  'Copyright': 'Worldwide rights ©Salvador Dalí. Fundació Gala-Salvador Dalí (Artists Rights Society), 2017 / In the USA ©Salvador Dalí Museum, Inc. St. Petersburg, FL 2017.',
  'Description': 'This Realist panel demonstrates that by 1926, Dalí’s formative years were drawing to a close; Dalí could achieve mastery in whatever style he chose. This painting has another distinction – it was one of the first Dalí paintings to be seen in America. In 1928 it was exhibited at the Carnegie Institute in Pittsburgh, along with two other works.
  The artist’s use of detailed illusionism and dramatic lighting against an almost black background alludes to the influence of the Spanish painter Francisco de Zurbarán (1598-1664), demonstrated in his work Still Life with Lemons, Oranges and a Rose, 1633. A contemporary of Diego Velázquez (1599-1660), de Zurbarán was renowned for his works’ austere piety and quiet beauty. Dalí saw bread as the staple of life of the Catalan people.
  Bread was the most basic element that united Catalans in their daily lives, and like Vermeer and Zurbarán, he renders it as a sublime symbol.
  The painstaking realism of The Basket of Bread was a major achievement and marked a turning point in his career. It boosted Dalí’s ego and gave him a sense of mastery with traditional painting, freeing him to explore more difficult subject matter and imagery. This simple composition of bread in a straw basket on cloth is set dramatically against a dark background. Dalí followed in the Spanish still-life tradition, where a domestic scene represents spiritual reflection.
  By saturating the objects in such a mysterious light, he transforms the composition into an object of deep contemplation.
',
  'ExhibitionHistory': [
...
{
  'url': 'http://archive.thedali.org//MWEBimages/Collection Images/OILS_images saved for Web/1981.2_Girl-with-Curls_web_before conservation.jpg',
  ...
  'Accession ID Number': '1981.2',
  'Credit Line': 'Gift of A. Reynolds & Eleanor Morse',
  'Location': 'ON VIEW',
  'Copyright': 'Worldwide rights ©Salvador Dalí. Fundació Gala-Salvador Dalí (Artists Rights Society), 2017 / In the USA ©Salvador Dalí Museum, Inc. St. Petersburg, FL 2017.',
  'Description': 'This work foreshadows Dalí’s Surrealist style, for it presents a mysterious tableaux painted with hallucinatory clarity. While the blend of realism and distortion in Girl with Curls offers a glimpse of the Surrealist style Dalí would become famous for, it was painted three years before he joined the movement. Several ambiguous elements in the composition make it feel more like a dream than a representation of reality. First, judging by the scale of the building next to the
   girl, she appears to be too large for the landscape in which she stands. Secondly, the girl’s face is hidden from view, creating a sense of mystery and not providing any psychological details that her features could provide. And lastly, while the landscape is painted in a fairly realistic manner, the curves of the girl’s body are highly exaggerated – looking like she stepped out of a dream. This girl originated in childhood fantasies about a fictional Russian girl whom he nicknamed
   “Galuchka.” He saw this girl in one of the images in an optical theater/stereoscopic box in the house of his childhood teacher, Señor Trayter. These images “were to stir [Dalí] for the rest of his life”. She became his dream girl onto whom he could project all of his desires.

  Dalí pays homage to neoclassicism and its Catalan variant Noucentisme proposed by the writer Eugenio D\'Ors in this alluring painting. Here he represents the unusual the view of a young girl seen from behind and located in an Ampurdán landscape treated in an Italianate style. The representation of a figure viewed from behind is a pretext for painting the expansive landscape imbued with psychological tension, with its high sky and dramatic crescent moon, as we are invited to look over her
  shoulder and therefore identify with her point of view. Though her sculptural pose ( or "contrapposto") and the treatment of the landscape point to classical motifs, the device of looking over her shoulder derives from Romantic painting, and her exaggeratedly curving hips introduce the erotic into what is otherwise a restrained subject.

Dalí later explained how this figure was transformed from the adolescent girl Dullita into the literary figure of Gradiva and eventually reborn as his wife Gala. Gradiva was a mythic, literary phantasm, who was notable for how her foot was elegantly raised when walking, the subject of a popular novel analyzed by Freud at the beginning of the 1900s, but only translated into French in 1931. At this time Dalí adopted this subject, making it part of his personal mythology and imbuing this figure
with subjective symbolism. Indeed, Gradiva became one of the artist\'s central concerns during the 1930s.',
  'ExhibitionHistory': [
      '1926, Barcelona, Galeries Dalmau, "Exposició S. Dalí"',
